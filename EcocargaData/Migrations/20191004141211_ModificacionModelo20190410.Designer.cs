...
namespace Cl.Gob.Energia.Ecocarga.Data.Migrations
{
    ...
    [Migration("20191004141211_ModificacionModelo20190410")]
    partial class ModificacionModelo20190410
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cl.Gob.Energia.Ecocarga.Data.Models.DataCargador", b =>
                {
                    ...
                    b.Property<string>("DisponibleDescripcion")
                        .HasColumnName("disponible_descripcion")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Cl.Gob.Energia.Ecocarga.Data.Models.DataElectrolinera", b =>
                {
                    ...
                    b.Property<bool>("EstadoElectrolinera")
                        .HasColumnName("estado_electrolinera");

                    b.Property<string>("EstadoElectrolineraDescripcion")
                        .HasColumnName("estado_electrolinera_descripcion")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Cl.Gob.Energia.Ecocarga.Data.Models.DataTipocobro", b =>
                {
                    ...
                    b.Property<int>("UnidadCobroId")
                        .HasColumnName("unidad_cobro_id");

                    b.HasKey("Id");

                    b.HasIndex("CargadorId");

                    b.HasIndex("UnidadCobroId");
            ...
            modelBuilder.Entity("Cl.Gob.Energia.Ecocarga.Data.Models.DataUnidadcobro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Cl.Gob.Energia.Ecocarga.Data.Models.DataTipocobro", b =>
                {
                    ...
                    b.HasOne("Cl.Gob.Energia.Ecocarga.Data.Models.DataUnidadcobro", "UnidadCobro")
                        .WithMany("DataTipocobroUnidadCobro")
                        .HasForeignKey("UnidadCobroId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
